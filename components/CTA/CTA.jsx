      ...
      <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="/career"
              className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-[#42568C] shadow-xs hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Looking for Work?
            </a>
            <a
              href="/contact-us"
              className="text-sm/6 font-semibold text-white border border-white rounded-md px-3.5 py-1.5"
            >
